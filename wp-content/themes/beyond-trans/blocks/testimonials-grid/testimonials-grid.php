...
<section class="block testimonials-grid">
    <div class="container">
        <div class="testimonials-grid__header">
            <?php if ($heading): ?>
                <h2 class="testimonials-grid__heading fade-in"><?php echo esc_html($heading); ?></h2>
            <?php endif; ?>
            <?php if ($subheading): ?>
                <p class="testimonials-grid__subheading fade-in"><?php echo esc_html($subheading); ?></p>
            <?php endif; ?>
        </div>
        ...
        <div class="testimonials-grid__container">
            ...
            ?>
                <div class="testimonials-grid__item">
                    <?php if ($star_rating): ?>
                        <div class="testimonials-grid__stars fade-in">
                    ...
                    <?php if ($quote): ?>
                        <div class="testimonials-grid__quote fade-in">
                            <blockquote>
                    ...
                    <div class="testimonials-grid__author fade-in">
