...
// Set block classes
$block_classes = ['block', 'testimonials-slider'];
if (!empty($bg_class)) {
...
// Add a unique ID for the slider
$slider_id = 'testimonials-slider-' . uniqid();

// Count testimonials
$testimonial_count = count($testimonials);
$slick_classes = ['testimonials-slider__slick'];
if ($testimonial_count < 3) {
    $slick_classes[] = 'testimonials-slider--align-left';
}
                ...
                <div class="testimonials-slider__item">
                    ...
                    <div class="testimonials-slider__author fade-in">
                        <div class="testimonials-slider__author-info">
                            ...
                            <?php if ($affiliation): ?>
                                <p class="testimonials-slider__author-affiliation"><?php echo esc_html($affiliation); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
